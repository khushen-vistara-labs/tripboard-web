...
function TripDetails({ details, open, onToggle }: { details: NonNullable<ItineraryItem["details"]>; open: boolean; onToggle: (open: boolean) => void }) {
